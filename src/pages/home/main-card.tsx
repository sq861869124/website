  ...
  return (
    <PageContent className="erda-home-main-card">
      ...
      <div className="card-desc mt16">
        Erda Cloud 是一款在线 DeveOps 平台，一站式提供项目协作、代码托管、CI/CD、测试管理和微服务治理平台，让开发者更专注于自身业务架构设计开发，团队高效沟通、迭代开发过程缩短、轻松方便的运维等，都可以交给 Erda Cloud 来提供方案解决。
      </div>
      <div className="img-wrapper mt20">
        <ImgLazy src="/images/home/main.png"/>
      </div>
    </PageContent>
  )
}
