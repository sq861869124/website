    ...
    <div className="erda-home-pm">
      <PageContent>
        ...
        <div className="mt44 img-wrapper">
          <ImgLazy className="main-img" width={800} src="/images/home/Pic2.png"/>
          <ImgLazy className="male" width={100} src="/images/home/Pic2-1.png"/>
          <ImgLazy className="female" width={100} src="/images/home/Pic2-2.png"/>
        </div>
      </PageContent>
    </div>
  )
